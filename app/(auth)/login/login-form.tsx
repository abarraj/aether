// Login form client component with password, magic link, and Google OAuth.
'use client';
      ...
      {showForgotPassword && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div
            ...
            aria-hidden
          />
          <div className="relative w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-950 p-6 shadow-xl">
            {!resetSent ? (
              <>
